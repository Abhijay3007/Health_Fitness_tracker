...
export default function LoginPage() {
  ...
  const handleGoogleSignIn = () => {
    // Standard OAuth call - in local development this will trigger NextAuth redirect
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Seeding credentials help for testing */}
      <div className="p-3.5 rounded-xl border border-primary/20 bg-primary/5 text-xs text-muted-foreground space-y-1.5">
        <p className="font-bold text-primary">Quick Test Credentials (from Seeding):</p>
        <p>👤 <strong>User:</strong> user@tracker.com / User@123</p>
        <p>🛠️ <strong>Admin:</strong> admin@tracker.com / Admin@123</p>
      </div>
    </div>
  );
}
